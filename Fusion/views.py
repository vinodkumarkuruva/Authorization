...
def send_alert(email):
    ...
    mail.send(msg)
    return "Please check your email - confirmation email sent."
...
def signup():
    ...
    return jsonify({"msg": "User and Organization created", 'alert': a}), 201
...
def invite_member():
    ...
    msg.body = f"Please use the following link to join the organization: {invite_link}"
